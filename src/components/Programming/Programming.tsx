...
const Programming = () => {
    ...
    const getData = async() => {
        await fetch('https://www.googleapis.com/books/v1/volumes/?q=programming&key=AIzaSyAtM9oy6pZ3r1jwDqSIA_2fO4Yy57J03Eg&maxResults=40').then(res=> res.json()).then(res => (
            setData(res.items)
        ))
    }
    console.log(data)
